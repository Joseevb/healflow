...
export function TrustIndicators() {
	return (
		<section className="py-20 bg-gradient-to-r from-slate-500 via-slate-600 to-slate-700 dark:from-slate-700 dark:via-slate-800 dark:to-slate-900 text-white -mx-10">
