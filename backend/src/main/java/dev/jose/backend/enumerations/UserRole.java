...
public enum UserRole {
    ...
    /**
     * Converts a string representation (matching enum constant names, case-insensitive) to a
     * UserRole enum. Throws IllegalArgumentException if not found. Example: "ADMIN" ->
     * UserRole.ADMIN
     *
