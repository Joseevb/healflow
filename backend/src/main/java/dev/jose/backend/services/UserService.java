...
public interface UserService {
   ...
   *     empty.
   */
  Flux<UserResponseDto> getAllUsers(Optional<UserRole> role);
   ...
   */
  Mono<UserResponseDto> getUserById(Long id) throws ResourceNotFoundException;
   ...
   */
  Mono<UserEntity> getUserEntityById(Long id) throws ResourceNotFoundException;
   ...
   * @param request The {@link UpdateUserRequestPatchDto} containing the fields to be updated. Only
   *     provided fields will be applied. Must not be {@code null}.
   * @return A {@link UserResponseDto} object representing the updated user.
   * @throws ResourceNotFoundException if no user is found with the provided {@code id}.
   */
  Mono<UserResponseDto> partiallyUpdateUserById(Long id, UpdateUserRequestPatchDto request)
      throws ResourceNotFoundException;

  /**
   * Fully updates an existing user's profile based on their ID. This method allows an administrator
   * to update any field, including the user's role.
   *
   * @param id The unique identifier (ID) of the user to update. Must not be {@code null}.
   ...
   * @throws ResourceNotFoundException if no user is found with the provided {@code id}.
   */
  Mono<UserResponseDto> updateUserById(Long id, UpdateUserRequestPutDto request)
      throws ResourceNotFoundException;
   ...
   * @throws ResourceNotFoundException if no user is found with the provided {@code id}.
   */
  Mono<Void> deleteUserById(Long id) throws ResourceNotFoundException;
}
