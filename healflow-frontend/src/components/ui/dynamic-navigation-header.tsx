...
export type NavItemDropdown = NavItemBase & {
	type: "dropdown";
	children: (NavItemLink | NavItemHighlight)[];
	buttonVariant?: VariantProps<typeof buttonVariants>["variant"];
};
		...
		highlight: () => (
			<li className="row-span-3">
				<NavigationMenuLink asChild>
					<Link
						href={item.href}
						className="from-muted/50 to-muted flex h-full w-full flex-col justify-end rounded-md bg-gradient-to-b p-6 no-underline outline-none select-none focus:shadow-md hover:bg-accent/5 transition-colors"
					>
